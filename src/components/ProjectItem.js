        ...
        <Grid 
          ...
          <Grid item md={6} xs={12}>
            <Grid container direction="column" style={(window.innerWidth < 960) ?{textAlign: "center"}:{textAlign: "end"}} className={classes.container}>
              ...
              <h3>
                <a target="_blank" rel="noreferrer" ref={ref} href={info.link}>{info.title}</a>
              </h3>
              ...
              <div className={classes.icons}>
                {"github" in info && 
                  <a target="_blank" rel="noreferrer" href={info.github}>
                    <svg
                      style={{marginRight: 0,
                              marginLeft: "3%"}}
        ...
        <Grid 
          ...
          <Grid item md={6} xs={12}>
            <Grid container direction="column" className={classes.container}>
              ...
              <div>
                {info.github !== "" && <a target="_blank" rel="noreferrer" href={info.github}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    role="img"
                    viewBox="0 0 24 24"
